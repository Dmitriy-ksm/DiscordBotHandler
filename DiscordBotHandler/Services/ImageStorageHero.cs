    ...
    class ImageStorageHero : IStorage<Image>
    {
        ...
        public Image GetObject(string key)
        {
            ...
            else
            {
                ...
                string path = Path.Combine("Cache", "heroImage", key);
