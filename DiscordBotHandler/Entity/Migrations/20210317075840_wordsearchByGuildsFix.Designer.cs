...
namespace DiscordBotHandler.Entity.Migrations
{
    ...
    [Migration("20210317075840_wordsearchByGuildsFix")]
    partial class wordsearchByGuildsFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordBotHandler.Entity.Entities.WordSearch", b =>
                {
                    ...
                    b.Property<ulong?>("WordSearchByGuildsGuildId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("WordSearchByGuildsGuildId");

                    b.ToTable("WordSearches");
                });

            modelBuilder.Entity("DiscordBotHandler.Entity.Entities.WordSearchByGuilds", b =>
                {
                    b.Property<ulong>("GuildId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("WordSearchesByGuilds");
                });
            ...
            modelBuilder.Entity("DiscordBotHandler.Entity.Entities.WordSearch", b =>
                {
                    b.HasOne("DiscordBotHandler.Entity.Entities.WordSearchByGuilds", null)
                        .WithMany("WordSearches")
                        .HasForeignKey("WordSearchByGuildsGuildId");
                });
